...
// Respond ONLY with:
// 1. The code itself (no explanations)
// 2. No markdown backticks or blocks
// 3. Minimal comments only when absolutely necessary
...
//       )
//     ) {
//       return NextResponse.json({ error: "Invalid Google API key" }, { status: 401 });
//     }
